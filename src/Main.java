public class Main {
    ...
    public static void main(String[] args) {
        Texto teste = new Texto("Diz a sabedoria popular que um homem só tem uma "+
                "vida completa quando planta uma árvore, escreve um livro e tem um filho. Ao meu ver, não "+
                "se diz isso pensando de forma literal, mas sim na importância abstrata destes feitos. Ao "+
